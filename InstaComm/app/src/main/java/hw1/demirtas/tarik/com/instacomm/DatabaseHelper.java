...
public class DatabaseHelper extends SQLiteOpenHelper {
    public static String DATABASE_NAME="insta";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        try {
            sqLiteDatabase.execSQL(CommentsDB.CREATE_TABLE_SQL);
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        try {
            sqLiteDatabase.execSQL(CommentsDB.DROP_TABLE_SQL);
    ...
    public Cursor getAllRecordsMethod2(String sql , String...where){
        Cursor cursor = db.rawQuery("select * from "+CommentsDB.TABLE_NAME,where);
        Log.d("DATABASE OPERATIONS", "GET THE RECORDS");
